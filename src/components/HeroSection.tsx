      ...
      >
        ...
        <div className="flex-1 space-y-5 max-w-xl lg:max-w-2xl">
          ...
          >
            ...
            <span className="mt-1 block text-base sm:text-lg font-semibold text-[#FFB347]">
          ...
          >
            <div className="flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center rounded-full bg-[#E11D20] px-5 py-2.5 text-sm font-semibold shadow-[0_20px_50px_rgba(185,28,28,0.7)] hover:bg-[#B91C1C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#F97316] focus-visible:ring-offset-black transition will-change-transform"
        ...
        >
          <div className="relative mx-auto max-w-xs xl:max-w-sm">
            <div className="pointer-events-none absolute -inset-1 rounded-[32px] bg-gradient-to-tr from-[#FF6A00]/60 via-[#FFB347]/30 to-transparent opacity-60 blur-2xl" />
            <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-black/55 px-4 py-4 shadow-[0_16px_40px_rgba(0,0,0,0.6)] backdrop-blur-xl">
              <div className="mb-3 flex items-center justify-between gap-2">
                ...
                <span className="rounded-full bg-white/10 px-2 py-1 text-[11px] font-semibold text-[#FDBA74] inline-flex items-center gap-1">
